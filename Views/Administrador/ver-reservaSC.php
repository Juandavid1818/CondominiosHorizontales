                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title d-flex align-items-center">
                                <div class="icon-content p-2 rounded-circle" style="background-color: #0000FF; padding:25px; ">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box-head">
                                    <div class="p-2  d-flex justify-content-end">
                                        ...
                                        <button id="GenerarPDF" class="btn btn-warning "><a class="text-light" href="../../services/generatepdfSalonComunal.php" target="_blank">Generar PDF</a></button>
                                        <button id="GenerarExcel" class="btn p-2 btn-success mx-3 "><a class="text-light" href="../../services/generateexcelSalonComunal.php" target="_blank">Generar Excel</a></button>
