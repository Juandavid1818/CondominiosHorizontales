                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title d-flex align-items-center">
                                ...
                                <h1 style="font-size: 1.5rem;" class="ms-4">Mantenimiento Harmony</h1>
                            </div>
                            <div class="paragr-content">
                        <p>Lleva un registro de los mantenimientos necesarios en las zonas comunes.</p>
                    </div>
                        </div>
                    </div>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Manteniemiento Harmony</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <tr class="d-flex row border rounded-top rounded-3">
                                                    ...
                                                    <th class="d-flex col-md-2">
                                                        <div
                                                            ...
                                                            class="ms-2">Tipo de mantenimiento</span>
                                                    </th>
                                                    <th class="d-flex col-md-2">
                                                        <div
                                                            style="padding-bottom: 8px; border-bottom: 3px solid #0000FF; justify-content: center; display: flex; align-items:center; width: 45px; height: 45px;">
