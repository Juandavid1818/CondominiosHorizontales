    ...
    public function enviarNuevaClave($identificacion, $email)
    {
        ...
        if ($f) {
            ...
            try {
                ...
                $mail->Username = 'condominioshorizontales@gmail.com'; //SMTP username
                ...
                //Recipients
                // Emisor
                $mail->setFrom('condominioshorizontales@gmail.com', 'Soporte Condominios Horizontales');
